...
public class MyTestHDFSConn {
    ...
    private String uri ;
    private String dir = "/user/output1";
    private String parentDir = "/user";

    /**
     * for test
     */
    public MyTestHDFSConn(){
        this.uri = "hdfs://127.0.0.1:9000";
    }

    /**
     * real constructor
     */
    public MyTestHDFSConn(String uri){
        this.uri = uri;
    }
    ...
    public boolean append(String hdfsFile, String content) throws Exception {
        ...
        if (fs.exists(path)) {
            ...
            this.createNewHDFSFile(hdfsFile, content);
        }
        return true;
    }
